...
const addUsers=async(req,res,next)=>{
    ...
    const{name,DOB,address,phoneNumber,email,username,password,nic,role}=req.body;

    let users;

    try{
        users=new User({name,DOB,address,phoneNumber,email,username,password,nic,role});
        await users.save();
    }catch(err){
        console.log(err);
    }
...
const updateUser = async (req, res, next) => {
    ...
    const { name, DOB, address, phoneNumber, email, username,nic, role } = req.body; // Destructure user details from the request body
    ...
    try {
      ...
      const update = {
        ...
        username,
        nic,
        role // Exclude password field from the update object
      };
...
const signUp = async (req, res, next) => {
    ...
    try {
        ...
        const newUser = new User({ name, DOB, address, phoneNumber, email, username, password,nic });
        await newUser.save();
